...
export const themeConfig: ThemeConfig = {
  ...
  color: {
    ...
    light: {
      ...
      primary: 'oklch(0.25 0.01 242)',
      // secondary color
      // used for post text
      secondary: 'oklch(0.2 0.01 242)',
      // background color
      background: 'oklch(0.99 0.005 298)',
      // highlight color
  ...
  comment: {
    ...
    // https://giscus.app/
    giscus: {
      repo: 'gelaechter/gelaechter.github.io',
      repoId: 'R_kgDOQzvOlA',
      category: 'Comments',
      categoryId: 'DIC_kwDOQzvOlM4C-RFk',
      mapping: 'pathname',
      strict: '0',
      reactionsEnabled: '1',
      emitMetadata: '0',
